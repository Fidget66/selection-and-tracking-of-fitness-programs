...
values ('00000000-0000-0000-0000-000000000001', 'Сушка',
        'Сушка тела – комплекс мероприятий, включающий специальную систему питания и физических упражнений, направленный ' ||
        'на достижение подтянутого рельефного тела. Специфическая система питания помогает быстрее сжечь жировую прослойку и нарастить мышцы. ' ||
...
INSERT INTO category_of_fitness_program(id, short_name, description)
values ('00000000-0000-0000-0000-000000000002', 'Укрепление здоровья',
...
INSERT INTO category_of_fitness_program(id, short_name, description)
values ('00000000-0000-0000-0000-000000000003', 'Улучшение жизненного тонуса, выносливости',
...
INSERT INTO category_of_fitness_program(id, short_name, description)
values ('00000000-0000-0000-0000-000000000004', 'Силовые тренировки',
...
values ('00000000-0000-0000-0001-000000000001', 'ноги и грудь', 23, 45, 96, 'm', 3,
        'Приседания со штангой – 5 подходов по 12 повторений. Румынская тяга' ||
        ...
        '4 подхода по 15 повторений', '00000000-0000-0000-0000-000000000001');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000002', 'руки и пресс', 14, 37, 110, 'f', 2,
        'Жим узким хватом – 4 подхода по 15 повторений. Подъемы на бицепс' ||
        ...
        'подходов по максимуму', '00000000-0000-0000-0000-000000000001');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000003', 'Йога', 17, 60, 150, 'f', 3,
        '1. Отдых. Сделайте 2–3 спокойных вдоха-выдоха, примите удобную позу, ' ||
        ...
        ' расслабьтесь.', '00000000-0000-0000-0000-000000000002');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000004', 'Увеличиваем бицепсы', 21, 50, 100, 'm', 4,
        'Качаем бицепсы. Необходимо выполнить поочерёдно подъёмы гантелей, ' ||
        ...
        ' по десять раз за подход. Тренируем ноги. Следует выполнять выпады вперёд с использованием гантелей.',
        '00000000-0000-0000-0000-000000000004');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000005', 'Дыхательная гимнастика', 19, 100, 110, 'm', 2,
        'Упражнение 1. Исходное положение — стоя, ноги на ширине плеч. ' ||
        ...
        'данной группы упражнений рекомендуется контрастный душ для ног в течение пяти минут на каждую.',
        '00000000-0000-0000-0000-000000000003');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000006', 'Дыхательная гимнастика: велосипед', 20, 70, 90, 'f', 2,
        'Велосипед. Количество: 25 раз. Техника выполнения: ' ||
        ...
        'и высоту прыжков. Смотреть на официальном канале в YouTube. Отжимания. Количество: 20 раз. ',
        '00000000-0000-0000-0000-000000000003');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000007', 'Фитнесс для начинающих', 18, 50, 120, 'm', 4,
        'День 1-ый. Неспешная 30-минутная пробежка или быстрая ходьба. День 2-й отдыхаем. ' ||
        ...
        'все по кругу', '00000000-0000-0000-0000-000000000002');
INSERT INTO fitness_program(id, short_name, duration, age_restriction, weight_restriction, sex_restriction,
                            exercise_per_week,
                            description, category_id)
values ('00000000-0000-0000-0001-000000000008', 'Фитнесс для начинающих', 22, 40, 120, 'f', 3,
        '1. Скручивания на пресс. Прорабатывает мышцы пресса. Лягте на ' ||
        ...
        '0 сустав.', '00000000-0000-0000-0000-000000000004');

INSERT INTO users (id, first_name, last_name, date_of_birth, sex, weight, email)
values ('00000000-0000-0000-0002-000000000001', 'Petr', 'Ivanov', '1980-03-12', 'm', 86, 'petrIvanov@mail.ru');
INSERT INTO users (id, first_name, last_name, date_of_birth, sex, weight, email)
values ('00000000-0000-0000-0002-000000000002', 'Olya', 'Mak', '1985-04-22', 'f', 55, 'Busnab@mail.ru');
INSERT INTO users (id, first_name, last_name, date_of_birth, sex, weight, email)
values ('00000000-0000-0000-0002-000000000003', 'Andrey', 'Andreev', '1993-12-24', 'm', 80, 'Busnab@mail.ru');

INSERT INTO bookmark (fitness_program_id, user_id)
values ('00000000-0000-0000-0001-000000000001', '00000000-0000-0000-0002-000000000003');
INSERT INTO bookmark (fitness_program_id, user_id)
values ('00000000-0000-0000-0001-000000000003', '00000000-0000-0000-0002-000000000003');
INSERT INTO bookmark (fitness_program_id, user_id)
values ('00000000-0000-0000-0001-000000000002', '00000000-0000-0000-0002-000000000002');
INSERT INTO bookmark (fitness_program_id, user_id)
values ('00000000-0000-0000-0001-000000000007', '00000000-0000-0000-0002-000000000002');

INSERT INTO active_program (id, days, is_complited, fitness_program_id, user_id)
VALUES ('00000000-0000-0000-0003-000000000001', 'MONDAY;FRIDAY;SUNDAY', true, '00000000-0000-0000-0001-000000000006',
        '00000000-0000-0000-0002-000000000003');
INSERT INTO active_program (days, is_complited, fitness_program_id, user_id)
VALUES ('MONDAY;SUNDAY', true, '00000000-0000-0000-0001-000000000003', '00000000-0000-0000-0002-000000000003');
INSERT INTO active_program (days, is_complited, fitness_program_id, user_id)
VALUES ('MONDAY;SATURDAY', false, '00000000-0000-0000-0001-000000000001', '00000000-0000-0000-0002-000000000003');
INSERT INTO active_program (days, is_complited, fitness_program_id, user_id)
VALUES ('MONDAY;FRIDAY;SUNDAY', true, '00000000-0000-0000-0001-000000000004', '00000000-0000-0000-0002-000000000002');
INSERT INTO active_program (id, days, is_complited, fitness_program_id, user_id)
VALUES ('00000000-0000-0000-0003-000000000005', 'MONDAY;SATURDAY', false, '00000000-0000-0000-0001-000000000001',
        '00000000-0000-0000-0002-000000000002');

INSERT INTO review (author_id, author_name, text, fitness_program_id)
VALUES ('00000000-0000-0000-0002-000000000003', 'Petr', 'Отличная программа упражнений. Рекомендую!',
        '00000000-0000-0000-0001-000000000006');
INSERT INTO review (author_id, author_name, text, fitness_program_id)
VALUES ('00000000-0000-0000-0002-000000000003', 'Petr', 'Мне понравилось', '00000000-0000-0000-0001-000000000004');
INSERT INTO review (author_id, author_name, text, fitness_program_id)
VALUES ('00000000-0000-0000-0002-000000000002', 'Olya', 'Программа подойдет для всех',
        '00000000-0000-0000-0001-000000000004');

INSERT INTO exercise_schedule(program_short_name, exercise_date, is_complited, active_program_id)
values ('руки и пресс', '2021-11-17', false, '00000000-0000-0000-0003-000000000001');
INSERT INTO exercise_schedule(program_short_name, exercise_date, is_complited, active_program_id)
values ('руки и пресс', '2021-11-17', false, '00000000-0000-0000-0003-000000000005');